...
Uses **Bitfinex Exchange API** to get information about the leaderboard, which allows to track trader positions and profits. The code is very unorganized as I wanted to get it done asap, to know what two specific traders are doing during these times.
